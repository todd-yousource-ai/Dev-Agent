...
_Source: `TRD-10-Document-Store-Crafted.docx` — extracted 2026-03-24 21:18 UTC_
...
Storage | ~/Library/Application Support/Crafted/cache/{project_id}/
...
~/Library/Application Support/Crafted/
└── cache/
    └── {project_id}/
